...
then #clang usually gives smaller binary files. time executed remains to be tested
	clang++ main.cpp log.cpp preset.cpp helper.cpp defines.cpp -Os -march=native -Wall -Wextra -fno-common -fno-unroll-loops -o a.out
else
	g++ main.cpp log.cpp preset.cpp helper.cpp defines.cpp -O2 -march=native -Wall -Wextra -fno-common -o a.out
fi
